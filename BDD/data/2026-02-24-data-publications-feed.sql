...
-- Prerequis:
--   - 2026-02-23-data-publication.sql (types existants, seq a 10)
--   - 2026-02-22-data-test-reseau.sql (users 200-249)
...
INSERT INTO typepublication (idtypepublication, libelle) VALUES ('TPB000004', 'Actualite') ON CONFLICT DO NOTHING;
INSERT INTO typepublication (idtypepublication, libelle) VALUES ('TPB000005', 'Question') ON CONFLICT DO NOTHING;
INSERT INTO typepublication (idtypepublication, libelle) VALUES ('TPB000006', 'Conseil') ON CONFLICT DO NOTHING;

-- ======================== 100 PUBLICATIONS ========================
-- Repartition thematique par cluster + utilisateurs 100/101/102
...
INSERT INTO publication VALUES ('PUB000012','2025-11-04','Quelqu''un utilise Hibernate avec des entites complexes et a des problemes de N+1 queries ? J''ai passe 2 jours a deboguer ca chez mon entreprise, finalement resolu avec @BatchSize.',1,NULL,'09:32','TPB000005',101) ON CONFLICT DO NOTHING;
...
INSERT INTO publication VALUES ('PUB000014','2025-11-06','Partage d''experience : premier mois chez Axian Data en tant que Data Scientist. Les donnees reelles sont TRES differentes des datasets propres des cours. Courage a tous !',1,NULL,'14:22','TPB000004',100) ON CONFLICT DO NOTHING;
...
INSERT INTO publication VALUES ('PUB000018','2025-11-11','Retour de la Cisco Networking Academy Conference. Beaucoup de choses sur le SD-WAN et le Zero Trust Network Access. L''avenir des reseaux est clairement software-defined.',1,NULL,'18:30','TPB000004',100) ON CONFLICT DO NOTHING;
INSERT INTO publication VALUES ('PUB000019','2025-11-12','Question pour les devs frontend : est-ce que vous utilisez encore Redux ou vous avez migre vers Zustand/Jotai ? En React Native, Redux me semble un peu overkill maintenant.',1,NULL,'11:45','TPB000005',101) ON CONFLICT DO NOTHING;
...
INSERT INTO publication VALUES ('PUB000025','2025-11-19','Offre d''emploi : Ingenieur Securite Reseaux chez RiT, CDI. 2 ans d''experience minimum, certification CEH appr̩ciee. Poste base a Tana. Contactez HR.',1,NULL,'09:48','TPB000001',100) ON CONFLICT DO NOTHING;
INSERT INTO publication VALUES ('PUB000026','2025-11-20','Petit flex personnel : j''ai passe ma certification AWS Cloud Practitioner ! Premier pas vers Solutions Architect. Ca vaut le coup d''investir dans les certifs cloud.',1,NULL,'12:10','TPB000004',101) ON CONFLICT DO NOTHING;
INSERT INTO publication VALUES ('PUB000027','2025-11-21','Pour ceux qui utilisent Flutter : comment gerez-vous la gestion d''etat dans des apps complexes ? Riverpod vs Bloc, j''ai du mal a choisir pour mon projet actuel.',1,NULL,'14:40','TPB000005',102) ON CONFLICT DO NOTHING;
...
INSERT INTO publication VALUES ('PUB000030','2025-11-25','Je cherche un associe pour monter une startup autour de la cybersecurite pour les PME malgaches. Si tu as des competences en pentest ou audit securite, ecris-moi.',1,NULL,'19:30','TPB000004',102) ON CONFLICT DO NOTHING;
...
INSERT INTO publication VALUES ('PUB000033','2025-11-28','Hackathon Alumni ITU annonce ! Th̬me : "Tech pour le developpement durable a Madagascar". Equipes de 3-5 personnes. Inscriptions du 1 au 15 dec.',1,NULL,'09:00','TPB000003',102) ON CONFLICT DO NOTHING;
...
INSERT INTO publication VALUES ('PUB000035','2025-11-30','Qui utilise deja LangChain en production ici ? Je teste pour un chatbot RAG et j''ai des questions sur la gestion du contexte long pour les PDFs.',1,NULL,'12:22','TPB000005',100) ON CONFLICT DO NOTHING;
...
INSERT INTO publication VALUES ('PUB000041','2025-11-05','Les graphes de connaissances et Neo4j : quelqu''un a deja utilise ca pour des recommandations ? Je construis un moteur de recommandation pour une plateforme e-learning locale.',1,NULL,'14:15','TPB000005',100) ON CONFLICT DO NOTHING;
...
INSERT INTO publication VALUES ('PUB000043','2025-11-13','Ecran noir chez mon client : la VLAN mal configuree bloquait tout le trafic inter-services. 4h de debug. Lecon : documenter TOUTE configuration reseau, meme les "petits" changements.',1,NULL,'20:10','TPB000004',102) ON CONFLICT DO NOTHING;
...
INSERT INTO publication VALUES ('PUB000045','2025-11-21','Annonce : je rejoins Axian Cloud comme DevOps Engineer le mois prochain ! Merci a tous les alumni qui m''ont aide a preparer les entretiens. La communaute ITU est en or.',1,NULL,'18:05','TPB000004',101) ON CONFLICT DO NOTHING;
INSERT INTO publication VALUES ('PUB000046','2025-11-24','Discussion : React vs Vue vs Angular en 2025. Mon equipe veut standardiser. Quel framework recommendez-vous pour de grosses apps d''entreprise ?',1,NULL,'13:55','TPB000005',102) ON CONFLICT DO NOTHING;
...
INSERT INTO publication VALUES ('PUB000057','2025-12-09','Quelqu''un a de l''experience avec Keycloak pour la gestion IAM ? On l''implemente chez un client et la config SSO avec des apps legacy Java est complexe.',1,NULL,'14:30','TPB000005',100) ON CONFLICT DO NOTHING;
...
INSERT INTO publication VALUES ('PUB000060','2025-12-12','Retour sur le Hackathon Alumni : notre equipe a remporte le 2eme prix avec un systeme de monitoring de la qualite de l''eau par IoT + IA. Fiers de ce qu''on a accompli ensemble !',1,NULL,'19:15','TPB000004',101) ON CONFLICT DO NOTHING;
...
INSERT INTO publication VALUES ('PUB000066','2025-12-19','Mon premier CTF (Capture The Flag) : classement 47/230. Challenges en cryptographie et reverse engineering. Pour ceux qui veulent commencer : TryHackMe est tres accessible.',1,NULL,'22:05','TPB000004',102) ON CONFLICT DO NOTHING;
INSERT INTO publication VALUES ('PUB000067','2025-12-22','Joyeux fetes a toute la communaute Alumni ITU ! Cette annee a ete riche : certifications, nouvelles embauches, premieres lignes de code en prod. Soyez fiers du chemin parcouru.',1,NULL,'10:00','TPB000004',100) ON CONFLICT DO NOTHING;
...
INSERT INTO publication VALUES ('PUB000071','2025-12-28','Resolutions 2026 : passer AWS SAA, contribuer a 3 repos open source, creer mon premier package Python public. Quelles sont les votres ?',1,NULL,'11:00','TPB000005',100) ON CONFLICT DO NOTHING;
...
INSERT INTO publication VALUES ('PUB000073','2025-12-30','Prediction 2026 : l''IA generative va transformer les metiers du developpement mais ne les supprimera pas. Les devs qui sauront prompter et valider le code IA auront un enorme avantage.',1,NULL,'17:30','TPB000004',102) ON CONFLICT DO NOTHING;
INSERT INTO publication VALUES ('PUB000074','2025-12-31','Bilan 2025 : premiere certification obtenue, premier salaire en IT, premiere app deployee en prod. Merci ITU et merci la communaute alumni. Bonne annee 2026 !',1,NULL,'23:30','TPB000004',102) ON CONFLICT DO NOTHING;
...
INSERT INTO publication VALUES ('PUB000077','2026-01-05','Apprentissage en cours : Rust. Apres 2 semaines, je comprends enfin pourquoi le borrow checker existe. La memoire sans GC, c''est difficile mais fascinant.',1,NULL,'20:00','TPB000004',102) ON CONFLICT DO NOTHING;
INSERT INTO publication VALUES ('PUB000078','2026-01-07','Question technique : comment gerez-vous les secrets dans vos pipelines CI/CD ? HashiCorp Vault, AWS Secrets Manager, ou juste les env vars du CI ? On cherche la meilleure pratique.',1,NULL,'10:55','TPB000005',100) ON CONFLICT DO NOTHING;
...
INSERT INTO publication VALUES ('PUB000088','2026-01-21','Question : quelqu''un a de l''experience avec la migration d''Oracle vers PostgreSQL en production ? On a un schema complexe avec beaucoup de packages PL/SQL a reedcrire.',1,NULL,'09:45','TPB000005',102) ON CONFLICT DO NOTHING;
...
INSERT INTO publication VALUES ('PUB000093','2026-01-28','Recrutement : cherche associe technique pour une startup EdTech focus sur la preparation aux exams universitaires. Vision long terme, participation au capital possible.',1,NULL,'11:15','TPB000001',102) ON CONFLICT DO NOTHING;
INSERT INTO publication VALUES ('PUB000094','2026-01-29','Rapport de bug interessant : une race condition dans mon service de paiement n''apparaissait qu''avec plus de 200 requetes/s simultanees. Trouve grace aux tests de charge JMeter.',1,NULL,'19:00','TPB000004',101) ON CONFLICT DO NOTHING;
INSERT INTO publication VALUES ('PUB000095','2026-01-30','Nouvelle certification obtenue : Certified Kubernetes Administrator (CKA). 3 mois de preparation intensive. Exam tres pratique, pas de QCM. Pour ceux qui visent le cloud natif, ca vaut le coup.',1,NULL,'13:45','TPB000004',102) ON CONFLICT DO NOTHING;
...
INSERT INTO publication VALUES ('PUB000097','2026-01-31','Bilan janvier : 8 alumni ont decroches de nouvelles offres ce mois-ci via notre reseau. Le pouvoir du networking ! Si vous cherchez un poste, postez ici, la communaute joue le jeu.',1,NULL,'18:00','TPB000004',100) ON CONFLICT DO NOTHING;

-- ====== FEVRIER 2026 ======

INSERT INTO publication VALUES ('PUB000098','2026-02-02','J''ai parcouru 50 offres d''emploi IT a Madagascar ce weekend. Constat : 80% demandent Java ou Python, 60% citent Docker/Kubernetes, 40% mentionnent une certification cloud. Orientez votre apprentissage en consequence.',1,NULL,'10:00','TPB000006',101) ON CONFLICT DO NOTHING;
...
INSERT INTO publication VALUES ('PUB000105','2026-02-14','Meetup Valentine Day Alumni : ce soir 18h30 au Caf̩ de la Gare, networking informel pour tous les alumni tech. N''oubliez pas vos cartes de visite !',1,NULL,'12:00','TPB000003',100) ON CONFLICT DO NOTHING;
...
INSERT INTO publication VALUES ('PUB000108','2026-02-21','Je pr̩pare un atelier pratique Wireshark : analyse de trafic reseau, detection d anomalies, forensics basique. Niveau intermediaire requis. Qui est interesse ?',1,NULL,'10:40','TPB000003',100) ON CONFLICT DO NOTHING;

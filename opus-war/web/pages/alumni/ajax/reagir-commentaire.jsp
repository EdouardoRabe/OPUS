...
<%
    ...
    try {
        ...
        if (idcomm == null || idreaction == null) { out.print("{\"success\":false,\"error\":\"Parametres manquants\"}"); return; }
        int refuser = u.getUser().getRefuser();
        out.print(ReactionService.reagirCommentaire(refuser, idcomm, idreaction));
    } catch (Exception e) {
        e.printStackTrace();

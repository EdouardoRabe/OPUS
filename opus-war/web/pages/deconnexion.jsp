    ...
    <div class="login-box">
     <div class="login-logo">
      ...
      <div class="login-box-body" align="center">
          <a href="index.jsp"><img src="${pageContext.request.contextPath}/assets/img/logo.png" style="width: 95%; margin-bottom: 12px;" alt="Logo Acade" height="200" alt="logo-att"/></a>
        ...
        <a href="../index.jsp" class="button" ><button class="btn btn-success">Se reconnecter</button></a>

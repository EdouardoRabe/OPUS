    ...
    <div class="login-split">
      <div class="login-left">
        ...
        <div class="login-hero-wrap">
          ...
          <p class="login-hero-text">Votre compte a été créé avec succès. Il doit maintenant être validé par un administrateur pour garantir la qualité de notre réseau.</p>
        </div>
      </div>
      ...
      <div class="login-right">
        ...
        <div class="login-card" style="position: relative; z-index: 1;">
          ...
          <div style="text-align: center; padding: 1rem 0;">
            <div style="width: 80px; height: 80px; background: rgba(0, 139, 255, 0.1); color: var(--itu-blue); border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 2.5rem; margin: 0 auto 1.5rem;">
              <span class="glyphicon glyphicon-time" style="animation: pulse 2s infinite;"></span>
            </div>
            <h2 style="font-family: var(--font-serif); font-size: 1.8rem; color: var(--itu-dark); margin-bottom: 1rem; font-weight: 700;">Demande envoyée</h2>
            ...
            <a href="${pageContext.request.contextPath}/index.jsp" class="btn-login" style="text-decoration: none; display: inline-block;">

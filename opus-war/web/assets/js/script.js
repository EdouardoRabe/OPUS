...
function pagePopUp(page){
    if (document.getElementById("idlocalite")!=null){
     window.open(page+"&idlocalite="+document.getElementById("idlocalite").value,"","titulaireresizable=no,scrollbars=yes,location=no,width=1009,height=532,top=0,left=0");   
    }
    else{
...
function pagePopUp(page,width,height){
    if (document.getElementById("idlocalite")!=null){
     window.open(page+"&idlocalite="+document.getElementById("idlocalite").value,"","titulaireresizable=no,scrollbars=yes,location=no,width="+width+",height="+height+",top=0,left=0");   
    }
    else{

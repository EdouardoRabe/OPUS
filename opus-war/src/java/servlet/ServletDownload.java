    ...
    protected void doPost(HttpServletRequest arg0, HttpServletResponse arg1)
        ...
        try {
            ...
            if(arg0.getParameter("titre")!=null)
                titre = arg0.getParameter("titre").replaceAll(" ", "-");// j'ai rajout� le replace satria tsy tiny rehefa misy espace
            ...
            if (type.compareTo("0") == 0) {
                ...
                //teto navadika if ilay else if
                if (ext.compareTo("xls") == 0) {
                    arg1.setContentType("application/vnd.ms-excel");
                    os.write(("" + arg0.getParameter("table").replace('*', '"') + "" + htmlStringBasPage).getBytes());
                }

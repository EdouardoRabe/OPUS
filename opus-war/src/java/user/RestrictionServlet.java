...
import utilisateurAcade.Restriction;
...
public class RestrictionServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Restriction pr = new Restriction();
            pr.setIdrole(idr);
            pr.setIdaction(ida);
        
            pr.setTablename(nt);
      
            String req = "delete from restriction where idrole='" + idr + "' and tablename='" + nt + "' and idaction='" + ida + "'";
            out.print(req);
            ...
            out.println("ty ny antony:" + e.getCause().getMessage());
            e.printStackTrace();
